...
import { showNotification } from '../Profile/Notification';
...
useEffect(()=>{
  ...
  const response=await axios.get(`https://internareabackend-nrg6.onrender.com/api/application/${id}`)
      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 class="text-sm title-font text-gray-500 tracking-widest pb-1">Company name</h2>
            <h1 class="text-gray-900 font-bold title-font mb-4 -mt-8">{data.company}</h1>
