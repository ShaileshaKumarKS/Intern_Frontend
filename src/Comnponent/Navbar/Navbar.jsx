     ...
     </div>
     {
      user?(
        ...
        <div className='Profile'>
          ...
          <img src={avatar} alt=''onMouseEnter={showtheProfile}  className='rounded-full w-12'
          id='picpro'/>
              ...
              {isStudent?(
                <>
                 <div className="py-6">
                  ...
                  <div className='flex bg-white rounded-lg  cursor-pointer justify-center overflow-hidden mx-auto max-w-sm lg:max-w-4xl'>
