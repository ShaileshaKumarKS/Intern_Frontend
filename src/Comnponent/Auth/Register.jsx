        ...
        <div className='regi'>
          <div className='py-6'>
            <div className='flex bg-white rounded-lg justify-center shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl'>
              ...
              <a  href ="/"onClick={handleSignin} className='flex items-center h-9 justify-center mt-4 text-white  bg-slate-100 rounded-lg hover:bg-gray-100'>
        ...
        <div className="login">
          ...
          isDivVisible &&(
            ...
            <h5 id='state' className='mb-4 justify-center text-center'>
                ...
                <>
                 <div className="py-6">
                  ...
                  <div className='flex bg-white rounded-lg justify-center overflow-hidden mx-auto max-w-sm lg:max-w-4xl'>
                    <div className='w-full p-8 lg:w-1/2'>
                    <p onClick={handleSignin} className='flex items-center h-9 justify-center mt-4 text-white  bg-slate-100 rounded-lg hover:bg-gray-100'>
                    <div className="px-4 py-3">
                    <svg  class="h-6 w-6" viewBox="0 0 40 40">
                         <path d="M36.3425 16.7358H35V16.6667H20V23.3333H29.4192C28.045 27.2142 24.3525 30 20 30C14.4775 30 10 25.5225 10 20C10 14.4775 14.4775 9.99999 20 9.99999C22.5492 9.99999 24.8683 10.9617 26.6342 12.5325L31.3483 7.81833C28.3717 5.04416 24.39 3.33333 20 3.33333C10.7958 3.33333 3.33335 10.7958 3.33335 20C3.33335 29.2042 10.7958 36.6667 20 36.6667C29.2042 36.6667 36.6667 29.2042 36.6667 20C36.6667 18.8825 36.5517 17.7917 36.3425 16.7358Z" fill="#FFC107"/>
                         <path d="M5.25497 12.2425L10.7308 16.2583C12.2125 12.59 15.8008 9.99999 20 9.99999C22.5491 9.99999 24.8683 10.9617 26.6341 12.5325L31.3483 7.81833C28.3716 5.04416 24.39 3.33333 20 3.33333C13.5983 3.33333 8.04663 6.94749 5.25497 12.2425Z" fill="#FF3D00"/>
             ...
             <div className="mt-4 flex items-center justify-between">
                <p className='text-sm'>new to internarea? Register(<span className='text-blue-500 cursor-pointer'
                 onClick={closeLogin}>Student</span>/<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>company</span>) </p>
             </div>
               </div>
               </div>
               </div>
            ...
            <>
            <div className='flex bg-white rounded-lg justify-center overflow-hidden mx-auto max-w-sm lg:max-w-4x1'>
              <div className='w-full p-8 lg:w-1/2'>
              <div class="mt-4">
                <label class="block text-gray-700 text-sm font-bold mb-2">Email</label>
                <input class="text-gray-700 focus:outline focus:shadow-outline border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                type='email'  placeholder='john@example.com'/>  
              </div>
